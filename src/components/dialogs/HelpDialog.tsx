...
const HelpDialog = () => {
   return (
      <DialogContent className='max-w-2xl'>
         ...
         <DialogDescription className='grid gap-2 text-base text-white'>
            <p>
            ...
            <ol className='list-disc space-y-1 pl-4'>
               ...
               <li>
                  ...
                  click on the toggle{' '}
                  <strong className='px-2 font-zhun text-sm'>Edit: Off</strong>{' '}
                  button which will toggle the edit mode and give you access to
                  a bunch of other controls.
               </li>
               <li>
               ...
               <li>
                  You can quickly export your tier list to JSON by clicking on
                  the <Download className='inline h-4' /> button.
               </li>
               <li>
            ...
            <ol className='list-disc space-y-1 pl-4'>
               <li>
                  ...
                  might need to redo the entire logic of the existing drag and
                  drop or find a way to do it.
               </li>
               <li>
                  Rework the dataset for faster queries with more information so
            ...
            <p>
               You can contact <span className='px-2 font-mono'>niko_993</span>{' '}
               on discord if you run into any issues. I am always open to
               suggestions.
               <br />I also wanted to make this app open source but that will no
               longer keep my anonymity, I will do that when I am braver.
            </p>
         </DialogDescription>
      </DialogContent>
   )
